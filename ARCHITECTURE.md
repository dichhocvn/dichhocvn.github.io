...
- Theme/template + API ảnh lyso.vn (khóa config thủ công, ẩn legend/prompt và `#luuModeBar` khi ở mode API, URL ảnh có năm xem hạn từ `namXem`) -> `src/js/features/theme-config.js`
