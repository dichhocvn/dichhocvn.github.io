...
- `grid.css`: cung/sao/grid/highlight/pills; tách class cho cụm điều hướng xem hạn để style mobile/desktop riêng; tăng lớp hiển thị khu chính tinh và chỉnh header để vị trí 1/3 có width bằng nhau, vị trí 2 luôn centered và không bị đại vận che; sao hung (vị trí 6) căn phải theo cạnh nội dung (`display: table; margin-left: auto`), giữ một dòng và cho phép tràn về bên trái để đủ chữ; cát tinh vẫn cho phép overflow.
